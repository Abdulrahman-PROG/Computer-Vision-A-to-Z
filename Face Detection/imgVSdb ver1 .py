...
def recognize_image_against_folder(img_path, folder_path):
    ...
    for folder_img in folder_images:
        ...
        matches[folder_img] = match
        print(f"Comparing {img_path} with {folder_img}: {'Match' if match else 'No match'}")

    return matches

# Example usage
img_path = "C:\\Users\\Abdul\\OneDrive\\Pictures\\th (2).jpeg"
folder_path = "C:\\Users\\Abdul\\OneDrive\\Pictures\\db"
matches = recognize_image_against_folder(img_path, folder_path)
